...
// ============================================================================
// WorkflowPhaseReadyHandler — REMOVED
// ============================================================================
// Removed: `WorkflowPhaseReadyHandler` raced with the running Overmind and
// created agentless fan-out subtasks before the Overmind could call
// `workflow_fan_out` with proper agent assignments.  The Overmind now owns
// fan-out for every phase — it must call `workflow_fan_out` (with `agent` set
// on each slice) after `workflow_advance`.
